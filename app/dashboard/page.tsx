...
export default function Home() {
  ...
  const customLocations: LocationOption[] = [
    ...
    { label: "Sydney CBD and Inner City NSW, Australia", value: "sydney_CBD_And_InnerCity" },
  { label: "Sydney Eastern Suburbs NSW, Australia", value: "sydney_easternSuburbs" },
  { label: "Sydney Inner West NSW, Australia", value: "sydney_innerWest" },
  { label: "Sydney Lower North Shore NSW, Australia", value: "sydney_lowerNorthShore" },
  { label: "Sydney Upper North Shore NSW, Australia", value: "sydney_upperNorthShore" },
  { label: "Sydney Northern Suburbs NSW, Australia", value: "sydney_northernSuburbs" },
  { label: "Sydney Northern Beaches NSW, Australia", value: "sydney_northernBeaches" },
  { label: "Sydney Hills District NSW, Australia", value: "sydney_hillsDistrict" },
  { label: "Western Sydney NSW, Australia", value: "westernSydney" },
  { label: "Sydney South Western Sydney NSW, Australia", value: "sydney_southWesternSydney" },
  { label: "Sydney Sutherland Shire NSW, Australia", value: "sydney_sutherlandShire" },
  { label: "Sydney St George NSW, Australia", value: "sydney_stGeorge" },
  { label: "Sydney Macarthur Region NSW, Australia", value: "sydney_macarthurRegion" },
  { label: "Sydney Hawkesbury Region NSW, Australia", value: "sydney_hawkesburyRegion" },
  { label: "Sydney Other Suburbs NSW, Australia", value: "sydney_otherSuburbs" },

  // Melbourne regions
  { label: "Melbourne Inner City VIC, Australia", value: "melbourne_innerCity" },
  { label: "Melbourne Northern Suburbs VIC, Australia", value: "melbourneNorthernSuburbs" },
  { label: "Melbourne Eastern Suburbs VIC, Australia", value: "melbourneEasternSuburbs" },
  { label: "Melbourne Southern Suburbs VIC, Australia", value: "melbourne_southernSuburbs" },
  { label: "Melbourne Western Suburbs VIC, Australia", value: "melbournewesternSuburbs" },
  { label: "Melbourne Northern Outer Suburbs VIC, Australia", value: "melbournenorthernOuterSuburbs" },
  { label: "Melbourne Eastern Outer Suburbs VIC, Australia", value: "melbourneeasternOuterSuburbs" },

  // Brisbane regions
  { label: "Brisbane Inner City QLD, Australia", value: "brisbaneinnerCity" },
  { label: "Brisbane Northern Suburbs QLD, Australia", value: "brisbanenorthernSuburbs" },
  { label: "Brisbane Southern Suburbs QLD, Australia", value: "brisbanesouthernSuburbs" },
  { label: "Brisbane Eastern Suburbs QLD, Australia", value: "brisbaneeasternSuburbs" },
  { label: "Brisbane Western Suburbs QLD, Australia", value: "brisbanewesternSuburbs" },
];
